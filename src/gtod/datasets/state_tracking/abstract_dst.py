...
from gtod.common import dialog_pb2
from gtod.common import schema
from gtod.common import system_summary
...
class AbstractDST:
    ...
    def update_service_state(
        self, partial_dialog: dialog_pb2.Dialog, summary: system_summary.SystemSummary
    ):
    ...
    def get_transfer_candidates(
        self, partial_dialog: dialog_pb2.Dialog, service_schema: schema.ServiceSchema
